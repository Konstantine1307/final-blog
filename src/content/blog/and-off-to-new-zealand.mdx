...
heroImage: "@assets/hero-images/akaroa-christchurch.webp"
...
![Lunch in Akaora with our friends](/and-off-nz/akaora-lunch.webp 'Lunch in Akaora with our friends')

import SpecialText from '@components/SpecialText.astro'

<SpecialText variant="caption">Lunch in Akaora with our friend Caroline and Barrie</SpecialText>
...
![Lunch with niece Deborah in Christchurch](/and-off-nz/lunch-with-debs.webp 'Lunch with niece Deborah in Christchurch')

<SpecialText variant="caption">Lunch with Deborah in Christchurch</SpecialText>
...
![Tea with Frank and Shriley in Christchurch](/and-off-nz/frank-and-shirley.webp 'Tea with Frank and Shriley in Christchurch')

<SpecialText variant="caption">A tea with Leslie's uncle and aunt before hitting the road from Christchuch</SpecialText>
