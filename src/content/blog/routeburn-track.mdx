...
heroImage: "@assets/hero-images/pick-views.webp"
...
galleryImages:
    - caption: Routeburn Track memories
      src: /routeburn/johnny-at-the-top.webp
    - caption: Routeburn Track memories
      src: /routeburn/routeburne.webp
    - caption: Routeburn Track memories
      src: /routeburn/top-pond.webp
    - caption: Routeburn Track memories
      src: /routeburn/resting.webp
    - caption: Routeburn Track memories
      src: /routeburn/cautious-track.webp
    - caption: Routeburn Track memories
      src: /routeburn/cold-swim.webp
    - caption: Routeburn Track memories
      src: /routeburn/at-the-top.webp
    - caption: Routeburn Track memories
      src: /routeburn/green-valley.webp
    - caption: Routeburn Track memories
      src: /routeburn/on-the-edge.webp
    - caption: Routeburn Track memories
      src: /routeburn/pass.webp
    - caption: Routeburn Track memories
      src: /routeburn/pam.webp
    - caption: Routeburn Track memories
      src: /routeburn/bravo.webp
    - caption: Routeburn Track memories
      src: /routeburn/tata.webp
    - caption: Routeburn Track memories
      src: /routeburn/final-stop.webp
    - caption: Routeburn Track memories
      src: /routeburn/final-stop-2.webp
    - caption: Routeburn Track memories
      src: /routeburn/final-stop-3.webp
    - caption: Routeburn Track memories
      src: /routeburn/pam-quinn.webp
    - caption: Routeburn Track memories
      src: /routeburn/alpine.webp
    - caption: Routeburn Track memories
      src: /routeburn/leslie-walk.webp
    - caption: Routeburn Track memories
      src: /routeburn/view-from-mountain.webp
    - caption: Routeburn Track memories
      src: /routeburn/johnny-valley.webp
    - caption: Routeburn Track memories
      src: /routeburn/lake.webp
    - caption: Routeburn Track - We made it
      src: /routeburn/final-stop-4.webp
...
![Queenstown from the hotel](/routeburn/queenstown.webp 'Queenstown from the hotel')
...
<IndentedText variant="chat">OMG, can we do this?</IndentedText>
<IndentedText variant="chat">I think my pack is too heavy</IndentedText>
<IndentedText variant="chat">I haven't walked 12 kms on the flat let alone up a mountain!</IndentedText>
<IndentedText variant="chat">I don't think my raincoat is waterproof.</IndentedText>
<IndentedText variant="chat">I've never done anything like this in my life</IndentedText>
<IndentedText variant="chat">I hope you don't snore, I don't want to spend the night listening to other snorers</IndentedText>
<IndentedText variant="chat">I have to pee at least three times a night</IndentedText>
<IndentedText variant="chat">my knees aren't good</IndentedText>
<IndentedText variant="chat">my hips need replacing</IndentedText>
<IndentedText variant="chat">my feet are blistered!</IndentedText>
...
<IndentedText variant="chat">night everyone</IndentedText>
<IndentedText variant="chat">see you in the morning</IndentedText>
<IndentedText variant="chat">sleep well</IndentedText>
...
![Some of us on route to the start](/routeburn/on-route.webp 'Some of us on route to the start')
...
<IndentedText variant="chat">There's an optional 30 minute excursion to Key Summit</IndentedText>
<IndentedText variant="chat">Lunch stop will be at the Earland Falls</IndentedText>
<IndentedText variant="chat">Where?</IndentedText>
<IndentedText variant="chat">Start walking and you'll find it.</IndentedText>
...
![Pam, Chitti and Johnny at the Key Summit](/routeburn/top-of-the-world.webp 'Pam, Chitti and Johnny at the Key Summit')
...
<IndentedText variant="chat">how you doing?</IndentedText>
<IndentedText variant="chat">great job</IndentedText>
<IndentedText variant="chat">you ok?</IndentedText>
<IndentedText variant="chat">sweet</IndentedText>
<IndentedText variant="chat">looking good</IndentedText>
...
![Routeburn track top of the world](/routeburn/valley.webp 'Routeburn track top of the world')
...
![Rocky path between the mountains](/routeburn/cold-track.webp 'Rocky path between the mountains')
...
<IndentedText variant="chat">how many layers do you think we'll need?</IndentedText>
<IndentedText variant="chat">I'm keeping my rain gear on top</IndentedText>
<IndentedText variant="chat">make sure you've got gloves and hats</IndentedText>
<IndentedText variant="chat">remember, Be Bold, Start Cold</IndentedText>

import ImageText from "@components/ImageText.astro"

<ImageText src="/routeburn/after-dinner.webp" alt="Breakfast and lunch preparation for the walk" caption="We need to pay credit to the whole Ultimate Hike Team for their care regarding the dietary needs of our group. We had gluten and dairy free; celiac and halal requirements amongst us which were all catered for without any additional fuss." />
...
<IndentedText variant="facts">waterproof clothing doesn't breathe and whilst it keep rain out it keeps sweat in</IndentedText>
<IndentedText variant="facts">socks collect water from your raincoat and slowly fill your boots</IndentedText>
<IndentedText variant="facts">waterproof boots retain water excellently</IndentedText>
<IndentedText variant="facts">morning tea is a forego-able extra in poor weather on a mountain side!</IndentedText>

![Mountain daisy](/routeburn/alpine-flowers.webp 'Mountain daisy')
...
![Harris Saddle lunch shelter](/routeburn/steamed-up.webp 'Harris Saddle lunch shelter')
...
![Ruth, Leslie and Johnny Routeburn falls](/routeburn/way-down.webp 'Ruth, Leslie and Johnny Routeburn falls')
...
![Pam, Chitti and Adie](/routeburn/the-three-soldiers.webp 'Pam, Chitti and Adie')
...
![Post walk celebrations](/routeburn/back-to-queenstown.webp 'Post walk celebrations')
