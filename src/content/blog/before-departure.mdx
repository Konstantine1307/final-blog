...
heroImage: "@assets/hero-images/aerial-summerhouse.webp"
...
![Johnny and Leslie waiting for the transport to Penzance train station](/before-departure/ready-to-go.webp "Johnny and Leslie waiting for the transport to Penzance train station")

import SpecialText from "@components/SpecialText.astro"

<SpecialText variant="caption">Johnny and Leslie waiting for the transport to Penzance train station</SpecialText>
