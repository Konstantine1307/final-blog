...
<SpecialText variant="chat">OMG, can we do this?</SpecialText>
<SpecialText variant="chat">I think my pack is too heavy</SpecialText>
<SpecialText variant="chat">I haven't walked 12 kms on the flat let alone up a mountain!</SpecialText>
<SpecialText variant="chat">I don't think my raincoat is waterproof.</SpecialText>
<SpecialText variant="chat">I've never done anything like this in my life</SpecialText>
<SpecialText variant="chat">I hope you don't snore, I don't want to spend the night listening to other snorers</SpecialText>
<SpecialText variant="chat">I have to pee at least three times a night</SpecialText>
<SpecialText variant="chat">my knees aren't good</SpecialText>
<SpecialText variant="chat">my hips need replacing</SpecialText>
<SpecialText variant="chat">my feet are blistered!</SpecialText>
...
<SpecialText variant="chat">night everyone</SpecialText>
<SpecialText variant="chat">see you in the morning</SpecialText>
<SpecialText variant="chat">sleep well</SpecialText>
...
<SpecialText variant="chat">There's an optional 30 minute excursion to Key Summit</SpecialText>
<SpecialText variant="chat">Lunch stop will be at the Earland Falls</SpecialText>
<SpecialText variant="chat">Where?</SpecialText>
<SpecialText variant="chat">Start walking and you'll find it.</SpecialText>
...
<SpecialText variant="chat">how you doing?</SpecialText>
<SpecialText variant="chat">great job</SpecialText>
<SpecialText variant="chat">you ok?</SpecialText>
<SpecialText variant="chat">sweet</SpecialText>
<SpecialText variant="chat">looking good</SpecialText>
...
<SpecialText variant="chat">how many layers do you think we'll need?</SpecialText>
<SpecialText variant="chat">I'm keeping my rain gear on top</SpecialText>
<SpecialText variant="chat">make sure you've got gloves and hats</SpecialText>
<SpecialText variant="chat">remember, Be Bold, Start Cold</SpecialText>
...
<SpecialText variant="facts">waterproof clothing doesn't breathe and whilst it keep rain out it keeps sweat in</SpecialText>
<SpecialText variant="facts">socks collect water from your raincoat and slowly fill your boots</SpecialText>
<SpecialText variant="facts">waterproof boots retain water excellently</SpecialText>
<SpecialText variant="facts">morning tea is a forego-able extra in poor weather on a mountain side!</SpecialText>
